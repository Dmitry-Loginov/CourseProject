...
{
    public partial class TeacherWithSubAvgForm : Form
    {
        ...
        public TeacherWithSubAvgForm()
        {
            InitializeComponent();
            bindingSource1.DataSource = LogEntities.vw_TeachersWithSubjectsAndAvgMark.ToList();
        ...
        private void сгенерироватьРепортToolStripMenuItem_Click(object sender, EventArgs e)
        {
